...
- [ ] fix parlacards dev
  ...
  - to da je v env vars treba napisat interno docker domeno (http://parlasite:8000, http://parlacards:3000, itd.) ni fajn ker hoče v browserju iste urlje klicat in pol tam crknejo
