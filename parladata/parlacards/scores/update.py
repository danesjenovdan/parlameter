...
from parlacards.scores.agreement_with_group import save_people_agreements_with_group
...
def run_analyises_for_new_data(timestamp=None):
    ...
    speech_playing_fields = new_speeches.distinct("session__organizations").values_list(
        "session__organizations", flat=True
    )
...
def force_run_person_analyses(timestamp=None, print_method=print):
    ...
    for playing_field in get_playing_fields(timestamp):
        ...
        save_people_agreements_with_group(playing_field, timestamp)
