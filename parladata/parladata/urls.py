...
router.register(r"amendments", AmendmentView)
router.register(r"procedure-types", ProcedureTypeView)
router.register(r"amendment-results", AmendmentResultView)
...
urlpatterns = [
    ...
    path(
        ...
        EndUserMembershipsView.as_view(),
        name="end-memberships",
    ),
]
