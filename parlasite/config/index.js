const config = {
  ...
  urls: {
    ...
    cdn: 'https://cdn.ajdovscina.parlameter.si',
    cards: 'https://glej.ajdovscina.parlameter.si',
  ...
  mandates: [
    ...
    { id: 2, name: '2022–2026', url: 'https://ajdovscina.parlameter.si' },
    { id: 1, name: '2018–2022', url: 'https://2018.ajdovscina.parlameter.si' },
  ],
